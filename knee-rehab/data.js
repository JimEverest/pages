...
const EXERCISES = [
  ...
  {id:"06", img:"06-seated-terminal-knee-ext", title:"坐姿夹瓶伸膝（股内侧肌）", zones:["desk"], goal:"股内侧肌等长发力", dose:"双脚夹瓶向内夹、伸直保持 10 秒；10 次 × 5 组", note:"核心是向内夹紧、感受内侧发力与燃烧"},
  ...
  {id:"27", img:"27-elevated-hamstring-stretch", title:"窗台支撑式腘绳肌拉伸", zones:["desk"], goal:"后侧链深度拉伸（伸直位）", dose:"20–30 秒 × 2–3", note:"脚跟架窗台/矮柜，膝伸直脚尖勾，挺背从髋前倾；平面别太高"},
  ...
  {id:"26", img:"26-distal-single-leg-glute-bridge", title:"远端单腿臀桥", zones:["evening","advanced"], goal:"腘绳肌强化（脚放远更练后侧）", dose:"保持 1–2 秒，12 次 × 3", note:"脚放远、脚跟发力；支撑腿可绑弹力带增强；腘窝抽筋则退阶"},
  ...
  {id:"25", img:"25-single-leg-deadlift", title:"单腿硬拉", zones:["advanced"], goal:"腘绳肌+臀+单腿稳定", dose:"保持 5–10 秒，12 次为一组", note:"扶桌平衡，脊柱水平中立、骨盆不向患侧倾；脚跟发力"},
